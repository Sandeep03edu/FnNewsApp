...
export class News extends Component {
  constructor(props) {
    ...
    document.title = `${this.capitalizeWord(this.props.category)} Newz`
  }
  ...
  // Method runs after render gets complete
  ...
  render() {
    return (
      <div className="container my-3">
        <h2>{this.capitalizeWord(this.props.category)} - Top Headlines</h2>
